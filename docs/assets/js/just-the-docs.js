...
function initSearch() {
  ...
  request.open('GET', 'deltamaniac.github.io/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'deltamaniac.github.io/assets/css/just-the-docs-' + theme + '.css');
}

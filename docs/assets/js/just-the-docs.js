(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://deltamaniac.github.io/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://deltamaniac.github.io/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://deltamaniac.github.io/assets/css/just-the-docs-' + theme + ".css"
      );
    };
